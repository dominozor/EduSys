$(document).ready(function() {
    ...
    $('.courseDate').click(function () {
        ...
        window.location.replace("http://localhost:8090/templates/date/date.html"); //That redirects to dates page
    });
    $('.courseExam').click(function () {
        ...
        window.location.replace("http://localhost:8090/templates/exam/exam.html"); //That redirects to dates page
    });
});